...
export default function Herosection() {
  return (
    <div className="overflow-hidden">
      ...
      <div className="relative bg-[url('/okey3.png')] bg-cover bg-center sm:bg-fixed h-[85vh] sm:h-screen">
        {/* Overlay */}
        <div className="absolute top-0 left-0 w-full h-full bg-black/50"></div>

        {/* Content */}
        <div className="relative w-full max-w-3xl pt-20 mx-auto z-10 flex items-center justify-start h-full">
          <div className="text-white text-4xl sm:text-5xl font-bold leading-tight p-6 sm:p-4 tracking-wide sm:text-[60px]">
            ...
            <p className="text-[15px] sm:text-[16px] font-light">
              I&apos;m a Creative and a Passionate Web Developer
            </p>
          </div>
        </div>
      </div>
